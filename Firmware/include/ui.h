...
protected:
    ...
    static uint16_t tuninglabel,controlsLabel,fpSlotSelect,fpStatLabel,batCellsLabel,wifi_ssid_text, wifi_pass_text,wifi_ap_ssid_text,wifi_ap_pass_text,switchHiddenSSID,saveWifiBtn,status,batLabel;
    static VCU* vcu;
